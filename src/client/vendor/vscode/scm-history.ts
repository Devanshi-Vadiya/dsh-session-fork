/*---------------------------------------------------------------------------------------------
 * VENDORED FROM: microsoft/vscode @ 611c5dfed2fb34ec3e5619bb6e77fdbd1e9d9541
 *   source:  src/vs/workbench/contrib/scm/browser/scmHistory.ts
 *   regions: 20-24 (swimlane/circle constants), 26-68 (ref colors, hover
 *            colors, 5-color graph palette, getLabelColorIdentifier),
 *            70-122 (createPath/drawCircle/drawDashedCircle/drawVerticalLine/
 *            findLastIndex draw helpers), 124-275
 *            (renderSCMHistoryItemGraph), 292-407
 *            (toISCMHistoryItemViewModelArray swimlane layout), 420-530
 *            (addIncomingOutgoingChangesHistoryItems — called by the layout
 *            function), 532-558 (compareHistoryItemRefs — called by the
 *            layout function).
 *   copied:  2026-08-21
 *
 ...
 * See License.txt in the vscode project root for license information.
 *--------------------------------------------------------------------------------------------*/

// [fork:adapt] import block: upstream vscode-internal paths are rewritten to
// this plugin's shim/types modules, one statement per upstream import.
// Upstream paths (relative to src/vs/workbench/contrib/scm/browser/):
//   ../../../../nls.js                                  -> ./shims.js (localize)
//   ../../../../base/common/objects.js                  -> ./shims.js (deepClone)
//   ../../../../platform/theme/common/colorRegistry.js  -> ./shims.js (badgeBackground, chartsBlue, chartsPurple, foreground)
//   ../../../../platform/theme/common/colorUtils.js     -> ./shims.js (asCssVariable, ColorIdentifier, registerColor)
//   ../common/history.js                                -> ./types.js (structural declarations + the two id constants)
//   ../../../../base/common/numbers.js                  -> ./shims.js (rot)
//   ../../../common/theme.js                            -> ./shims.js (PANEL_BACKGROUND)
//   ../../../../base/common/arraysFind.js               -> ./shims.js (findLastIdx)
// Upstream imports belonging to excluded regions only ($, svgElem,
// DisposableStore, IDisposable, IMarkdownString family, ThemeIcon,
// IMarkdownRendererService) are dropped.
import { localize } from './shims.js';
import { deepClone } from './shims.js';
import { badgeBackground, chartsBlue, chartsPurple, foreground } from './shims.js';
import { asCssVariable, ColorIdentifier, registerColor } from './shims.js';
import { ISCMHistoryItem, ISCMHistoryItemGraphNode, ISCMHistoryItemRef, ISCMHistoryItemViewModel, SCMIncomingHistoryItemId, SCMOutgoingHistoryItemId } from './types.js';
import { rot } from './shims.js';
